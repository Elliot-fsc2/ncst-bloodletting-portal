...
<body>
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans">
        ...
        <table class="w-full border-collapse border border-black text-center text-sm leading-tight mb-3">
            <tbody>
                <tr>
        ...
        <div class="flex justify-center mb-4">
            <div class="border border-black rounded-xl px-8 py-2 text-center text-sm">
                Place Barcode Sticker of<br>
                Donation ID no. here
            </div>
        </div>

        <div class="flex justify-between items-end gap-6 mb-3 px-2">
            ...
            <div class="w-1/3 flex flex-col items-center">
                <div class="border-b border-black w-full min-h-[20px] text-center text-sm font-semibold text-red-600">
                </div>
                <div class="text-sm mt-1">Blood Type</div>
            </div>
        </div>

        <div class="flex justify-between items-end gap-6 mb-4 px-2">
            <div class="w-1/3 flex flex-col items-center">
                <div class="border-b border-black w-full min-h-[20px] text-center text-sm font-semibold">
                </div>
        ...
        <div class="font-bold text-sm mb-2 px-2">
            PERSONAL DATA:
        </div>

        <div class="flex justify-between items-end gap-6 mb-2 px-2">
            <div class="w-1/3 flex flex-col items-center">
    ...
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans">
        <div class="flex flex-wrap items-end mb-4 text-sm gap-y-2">
            ...
            <div class="flex items-end mr-4">
                ...
                <div class="w-8 border-b border-black text-center min-h-[20px] font-semibold text-xs">
                    {{ $data['age'] ?? '' }}</div><span class="mx-1">/</span>
                <div class="w-8 border-b border-black text-center min-h-[20px] font-semibold text-xs">
                    {{ $data['sex'] ?? '' }}</div>
            </div>
        ...
        <div class="flex items-start mb-4 text-sm w-full">
            ...
            <div class="flex w-full gap-2">
                ...
                <div class="flex flex-col flex-grow-[1.5]">
                    <div class="border-b border-black w-full min-h-[20px] text-center font-semibold text-xs">
                        {{ $data['city_province'] ?? '' }}</div>
                    <div class="text-[11px] text-center mt-0.5">City/Province</div>
                </div>
            </div>
        </div>
        <div class="flex items-end mb-4 text-sm gap-6">
        ...
        <div class="flex flex-wrap items-end mb-5 text-sm gap-y-2">
            <div class="flex items-end flex-grow-[2] mr-4">
                <span class="mr-2 whitespace-nowrap">NAME OF PATIENT:</span>
                <div class="border-b border-black flex-grow min-h-[20px] text-center font-semibold text-xs">John Doe
                </div>
            </div>
            <div class="flex items-end flex-grow mr-4">
                <span class="mr-2 whitespace-nowrap">CATEGORY:</span>
                <div class="border-b border-black flex-grow min-h-[20px] text-center font-semibold text-xs">Relative
                </div>
            </div>
            <div class="flex items-end flex-grow">
                <span class="mr-2 whitespace-nowrap">WARD/ROOM NO.:</span>
                <div class="w-10 border-b border-black text-center min-h-[20px] font-semibold text-xs">W3</div><span
                    class="mx-1">/</span>
                <div class="w-10 border-b border-black text-center min-h-[20px] font-semibold text-xs">305</div>
            </div>
        </div>

        <div class="flex flex-col text-sm gap-2 mb-2">
    ...
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans">
        ...
        <table class="w-full border-collapse border-2 border-black text-[11px] leading-tight">
            ...
            <tbody>
                ...
                <tr>
                    <td class="border border-black p-1">
                        2. Have you ever donated or attempted to donate blood using different (or another) name here or
                        elsewhere?<br>
                        <span class="italic">Nakapagbigay ka na ba ng dugo na gumamit ng ibang pangalan dito o sa ibang
                            lugar?</span>
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <span class="italic">Ikaw ba ay hindi natanggap o nasabihan na hindi puwedeng magbigay ng dugo
                ...
                <tr>
                    <td class="border border-black p-1">
                        1. Have you within the last eighteen (18) months had any of the following: high blood pressure,
                        night sweats, unexplained fevers, unexplained weight loss, persistent diarrhea, enlarged lymph
                        node?<br>
                        <span class="italic">Sa nakaraang labing-walong (18) buwan, nagkaroon o nakaranas ka ba ng isa
                            sa mga sumusunod: alta-presyon, pagpapawis sa gabi, hindi maipaliwanag na lagnat, madalas na
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        shingles, cold sores, serious accident, cancer, blood disease like leukemia, recent or severe
                        respiratory disease, cardiovascular disease, kidney disease, syphilis, diabetes, asthma,
                        epilepsy, tuberculosis?<br>
                        <span class="italic">Nagkaroon o nakaranas sa mga sumusunod: malarya, sakit sa atay, paninilaw
                            ng mga mata at buong katawan, tulo, bulutong tubig, singaw, malubhang aksidente, kanser,
                            sakit sa dugo tulad ng leukemia o walang tigil na pagdurugo, sakit sa baga, sakit sa puso,
                ...
                <tr>
                    <td class="border border-black p-1">
                        3. Have you ever had a dental surgery for the past twelve (12) months or tooth extraction for
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <span class="italic">Nakagamit ng mga ipinagbabawal na gamut? (ininum, sininghot "cocaine" o
                ...
                <tr>
                    <td class="border border-black p-1">
                        5. Received blood or taken clotting factor concentrates for bleeding problem such as hemophilia
                        and had an organ or tissue transplant or graft?
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                </tr>
        ...
        <table class="w-full border-collapse border border-black text-center text-sm leading-tight mb-3">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-black p-1 text-left align-top w-[17.5%]">
                        <div class="text-[11px]">Page:</div>
                        <div class="font-bold">2 of 3</div>
                    </td>
                </tr>
    ...
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans">
        ...
        <table class="w-full border-collapse border-2 border-black text-[11px] leading-tight">
            ...
            <tbody>
                ...
                <tr>
                    <td class="border border-black p-1">
                        <span class="italic">Ikaw ba ay nasalinan ng dugo dahil sa hemophilia at naoperahan o nabigyan
                ...
                <tr>
                    <td class="border border-black p-1">
                        6. A tattoo applied, ear piercing, acupuncture, accidental needle stick or come in contact with
                        someone else's blood?<br>
                        <span class="italic">Nagpalagay ng tattoo, nagpabutas sa tenga, nagpa-akyupuncture, naturukan
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <span class="italic">Nagkaroon ng karanasan na makipagtalik sa kaparehong kasarian (lalaki sa
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <span class="italic">Nagkaroon ng karanasan sa taong naturukan ng gamot na walang pahintulot ng
                            doktor?</span>
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <span class="italic">Nagbayad kahit kanino para lang makipagtalik sa iyo o nakipagtalik kahit
                            kanino na tumatanggap ng pera o ng ipinagbabawal na gamot para lang makipag talik sa isang
                            tao?</span>
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                ...
                <tr>
                    <td class="border border-black p-1">
                        11. A sexual partner who is bisexual or medically unsupervised user of intravenous drug, who had
                        taken clotting factor concentrates for bleeding problem and has HIV or had a positive test for
                        HIV virus?<br>
                        <span class="italic">Nagkaroon ka ba ng kasintahan na nakikipagtalik sa kaparehong kasarian at
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        country/ies.<br>
                        <span class="italic">Sa nakalipas na dalawangpu’t walong araw, ikaw ba ay nag biyahe sa labas
                ...
                <tr>
                    <td class="border border-black p-1">
                        2. In the past 28 days, have you ever had close contact (live with, worked with, travelled with
                        or cared for)
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        illness?
                        <br>
                        <span class="italic">May nakasalamuha na may sintomas ng ubo, sipon, lagnat o acute respiratory
                            illness?
                        </span>
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                ...
                <tr>
                    <td class="border border-black p-1">
                        ...
                        <br>
                        <span class="italic">Ikaw ba ay nakatanggap na ng bakuna laban sa COVID-19? Kung Oo, Kailan at
                            anong bakuna
                ...
                <tr>
                    <td class="border border-black p-1">
                        1. When was your last delivery? _________ When was your last menstruation? _________
                        <br>
                        <span class="italic">Kailan ka huling nanganak?____________Kailan ka huling dinatnan/niregla?
                        </span>
                    </td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
                    <td class="border border-black p-1 text-center align-middle text-sm font-bold"></td>
        ...
        <table class="w-full border-collapse border border-black text-center text-sm leading-tight mb-3">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-black p-1 text-left align-top w-[17.5%]">
                        <div class="text-[11px]">Page:</div>
                        <div class="font-bold">3 of 3</div>
                    </td>
                </tr>
    ...
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans">
        ...
        <div class="font-bold text-sm mb-2">CONSENT</div>

        <div class="text-xs leading-relaxed mb-6 space-y-2 text-justify">
            <p class="indent-8">
                "I have read this form and understand its content and voluntarily give my consent for the collection,
                use, processing, storage and retention of my personal data or information to OPERATION LIFELINE - VMMC
                for the purpose described in this document. I also understand that my consent does not prevent the
                existence of other criteria for lawful processing of personal data and does not waive any of my rights
                under RA 10173- Data Privacy Act of 2012 and other applicable laws.
            </p>
            <p class="indent-8">
                It is my free and voluntary act and deed to donate my blood and I am aware of its risks and consequences
                during and after extraction having been explained to me in clear and understandable language and dialect
                that I speak."
            </p>
            <p class="indent-8">
                I understand that my blood will be screened for blood type, hemoglobin, malaria, syphilis, hepatitis B &
                C, and HIV 1 & 2 and no result will be issued to me. If found reactive, I agree to be referred to the
            ...
            <p class="indent-8 italic">
                "Nagpapatunay na ako ang taong tinutukoy at ang lahat ng nakasulat dito ay nabasa ko at naiintindihan at
                ako ay kusang loob na magbibigay ng dugo. Alam ko ang mga panganib at kahihinatnan sa mga sandaling
                kinukuhanan ako ng dugo hanggang sa matapos ang donasyon. Ito ay naipaliwanag sa akin at naiintindihan
                ko nang mabuti."
            </p>
            <p class="indent-8 italic">
                "Pagkatapos masagutan nang buong katapatan ang mga tanong, ako ay kusa at buong loob na magbibigay ng
                dugo sa OPERATION LIFELINE - VMMC. Naiintindihan ko na ang aking dugo ay susurin nang mabuti upang
                malaman ang blood type, hemoglobin, malaria, syphilis, hepatitis B at C, at HIV 1 at 2 at walang opisyal
                na resulta na ibibgay sa akin. Kung sakaling maging "reactive", ako ay sumasang-ayon na maisangguni sa
                nararapat na pasilidad para sa karagdagang pagsusuri.
            </p>
        </div>

        <div class="w-[60%] mx-auto mb-8 flex flex-col items-center">
        ...
        <div class="text-center font-bold text-base underline mb-4">
            FOR BLOOD BANK USE ONLY
        </div>

        <div class="font-bold text-sm underline mb-4">
            PHYSICAL EXAMINATION:
        </div>

        <div class="flex flex-wrap items-end mb-3 text-xs gap-x-2">
            <div class="flex items-end flex-grow">
        ...
        <div class="flex flex-wrap items-end mb-6 text-xs gap-x-2">
            <div class="flex items-end flex-grow-[2]">
        ...
        <div class="flex justify-between items-start text-xs">
            ...
            <div class="w-2/5 flex flex-col gap-1 mt-12">
            ...
            <div class="w-2/5 flex flex-col gap-6">
                ...
                <div class="flex flex-col items-start w-full mt-2 gap-1">
    ...
    <div class="max-w-5xl mx-auto p-2 bg-white text-black font-sans text-xs">

        <div class="flex justify-between items-start w-full">

            <div class="flex flex-col w-1/2 pr-4 gap-2 mt-4">
                <div class="flex flex-col w-64 mb-1">
                    <div class="border-b border-black w-full min-h-[16px]"></div>
                    <span>PHLEBOTOMIST (print name & sign)</span>
                </div>
                <div class="flex items-end">
                    <span class="w-24">Time Started:</span>
                    <div class="border-b border-black w-32 min-h-[16px]"></div>
                </div>
                <div class="flex items-end">
                    <span class="w-24">Time Finished:</span>
                    <div class="border-b border-black w-32 min-h-[16px]"></div>
                </div>
            </div>

            <div class="flex flex-col w-1/2 gap-2 mt-4">
                <div class="flex items-start h-[20px]">
                    <span>Remarks:</span>
                </div>
                <div class="flex items-end gap-2">
                    <span class="w-32">Sufficient Collection:</span>
                    <span class="tracking-widest">( )</span>
                    <div class="border-b border-black w-24 min-h-[16px]"></div>
                    <span>mL</span>
                </div>
                <div class="flex items-end gap-2">
                    <span class="w-32">Insufficient Collection:</span>
                    <span class="tracking-widest">( )</span>
                    <div class="border-b border-black w-24 min-h-[16px]"></div>
                    <span>mL</span>
                </div>
