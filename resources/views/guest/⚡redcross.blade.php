    ...
    <flux:card class="shadow-sm">
              ...
              <div class="space-y-6">
                  ...
                  <div>
                      ...
                      <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
                          <flux:input wire:model="personal.address_street" label="No. / Street" class="sm:col-span-1" />
                          <flux:input wire:model="personal.address_barangay" label="Barangay" class="sm:col-span-1" />
                          <flux:input wire:model="personal.address_town" label="Town/Municipality *" class="sm:col-span-1" />
                          <flux:input wire:model="personal.address_province" label="Province/City *" class="sm:col-span-1" />
          ...
          <div wire:transition>
              <div class="flex items-center gap-3 mb-6 pb-4 border-b border-red-100">
                  ...
                  <div>
                      ...
                      <p class="text-xs text-gray-500 mt-0.5">Please confirm all details are correct before submission.</p>
                  </div>
              </div>
        ...
        <div class="flex items-center justify-between gap-3 mt-8 pt-5 border-t border-gray-100">
            ...
            <div class="flex items-center gap-3">
                @if($step < 2)
                  <flux:button wire:click="nextStep" variant="primary" icon-trailing="chevron-right" class="bg-red-600! hover:bg-red-700!">Next</flux:button>
                @else
                  <flux:button wire:click="submit" variant="primary" icon="check" class="bg-red-600! hover:bg-red-700!">Submit & Generate PDF</flux:button>
                @endif
            </div>
        </div>
    </flux:card>
