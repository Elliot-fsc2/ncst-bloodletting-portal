...
<body
    class="antialiased min-h-screen relative [background:linear-gradient(135deg,#fff0f0_0%,#ffe4e4_50%,#fecaca_100%)] before:content-[''] before:fixed before:inset-0 before:bg-[radial-gradient(circle,rgba(220,38,38,0.07)_1px,transparent_1px)] before:bg-size-[26px_26px] before:pointer-events-none before:z-0">
